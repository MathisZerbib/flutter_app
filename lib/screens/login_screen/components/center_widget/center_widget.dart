...
class CenterWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    path.cubicTo(0.23 * width, 0.12 * height, 0.36 * width, 0.13 * height,
        0.48 * width, 0.14 * height);
    path.cubicTo(0.6 * width, 0.15 * height, 0.91 * width, 0.23 * height,
        0.94 * width, 0.34 * height);
    path.cubicTo(0.97 * width, 0.46 * height, 0.74 * width, 0.46 * height,
        0.66 * width, 0.56 * height);
